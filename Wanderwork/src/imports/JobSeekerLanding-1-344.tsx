...
function Group58() {
  return (
    <div className="absolute contents left-[116px] top-[76px]">
      <div className="absolute h-[43.791px] left-[1279px] top-[76px] w-[44px]" data-name="Menu">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-contain pointer-events-none size-full" src={imgMenu} />
      </div>
      <p className="absolute font-['Manrope:Bold',_sans-serif] font-bold h-[27.867px] leading-[24px] left-[116px] text-[#306770] text-[40px] top-[91.92px] tracking-[6px] w-[411px]">WANDERWORK</p>
    </div>
  );
}
...
export default function JobSeekerLanding() {
  return (
    <div className="relative shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] w-full min-h-screen pb-20" data-name="Job Seeker Landing">
      <div className="absolute h-[868px] left-0 top-[3545px] w-full -z-10" data-name="playa-chen-rio-cozumel">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
