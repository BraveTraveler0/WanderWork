  ...
  return (
    <div className="flex flex-col gap-4 lg:gap-6 xl:gap-8 w-full pl-2 lg:pl-2 pr-0 min-h-full overflow-visible pt-2 lg:pt-3 xl:pt-4" style={{ fontFamily: 'Manrope' }}>
      ...
      {(() => {
        ...
        const AGGREGATOR_HOSTS = ['jobicy.com', 'remoteok.com', 'arbeitnow.com', 'workingnomads.com']
        ...
        const applyUrl: string = (_rawApplyUrl && !isAggregator(_rawApplyUrl)) ? _rawApplyUrl : ''
